...
public class Main {
	...
	public static <T> void main(String[] args) {
	    ...
	    System.out.println("Índice [3] possui dados: "+alunos.existeDado(3));
	    System.out.println("Índice [6] possui dados: "+alunos.existeDado(6));
	    System.out.println();

	    System.out.println("Dado no índice [3]: "+alunos.recupera(3));
	    System.out.println("Dado no índice [6]: "+alunos.recupera(6));
	    System.out.println();
